...
function whenAfterDeployed(buildLocation, options) {
...
var Actions = (function () {
    ...
    */
    ...
    Actions.prototype.deploy = function (version, sites, options) {
        ...
        var buildLocation = process.env.BUILD_DIR || path.resolve(os.tmpdir(), getDefaultBuildDirName(this.config.appName, version));
