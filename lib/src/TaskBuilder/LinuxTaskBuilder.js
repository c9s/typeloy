...
var LinuxTaskBuilder = (function () {
    ...
    LinuxTaskBuilder.setup = function (config) {
    ...
    LinuxTaskBuilder.deploy = function (config, bundlePath, env, checkDelay, appName) {
    ...
    ;
    LinuxTaskBuilder.reconfig = function (env, appName) {
    ...
    LinuxTaskBuilder.restart = function (appName) {
    ...
    LinuxTaskBuilder.stop = function (appName) {
    ...
    LinuxTaskBuilder.start = function (appName) {
