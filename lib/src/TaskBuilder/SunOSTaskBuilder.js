...
var SunosTasks = (function () {
    ...
    SunosTasks.setup = function (installMongo, setupNode, nodeVersion, setupPhantom, appName) {
    ...
    SunosTasks.deploy = function (bundlePath, env, deployCheckWaitTime, appName) {
    ...
    SunosTasks.reconfig = function (env, appName) {
    ...
    ;
    SunosTasks.restart = function (appName) {
    ...
    SunosTasks.stop = function (appName) {
    ...
    SunosTasks.start = function (appName) {
