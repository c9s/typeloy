...
var Actions = (function () {
    ...
    */
    Actions.prototype.getTaskBuilderByOs = function (os) {
        switch (os) {
            case "linux":
    ...
    Actions.prototype._executePararell = function (actionName, deployment, args) {
        ...
        var promises = _.map(sessionInfoList, function (sessionsInfo) {
            return new Promise(function (resolve) {
                var taskListsBuilder = _this.getTaskBuilderByOs(sessionsInfo.os);
...
__export(require("./actions/StartAction"));
__export(require("./actions/StopAction"));
__export(require("./actions/RestartAction"));
__export(require("./actions/LogsAction"));
__export(require("./actions/SetupAction"));
__export(require("./actions/DeployAction"));
