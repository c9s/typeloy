...
var Actions = (function () {
    ...
    */
    ...
    Actions.prototype._executePararell = function (actionName, deployment, args) {
        ...
        var promises = _.map(sessionInfoList, function (sessionsInfo) {
            return new Promise(function (resolve) {
                ...
                var taskList = sessionsInfo.taskListsBuilder[actionName].apply(sessionsInfo.taskListsBuilder, args);
        ...
        return new Promise(function (resolveCompleted) {
            Promise.all(promises).then(function (mapResult) {
                var res = mapResult[0];
                _this.whenAfterCompleted(res.deployment, res.error, res.summary);
    ...
    Actions.prototype.deploy = function (deployment, sites, options) {
        ...
        var afterDeploy = new Promise(function (resolveDeploy, rejectDeploy) {
            ...
            afterBuild.then(function () {
                ...
                var pendingTasks = _.map(_this.sessionsMap, function (sessionsInfo) {
                    return new Promise(function (resolveTask, rejectTask) {
                        ...
                        taskList.run(sessions, function (summaryMap) {
                            resolveTask({ deployment: deployment, error: null, summary: summaryMap });
                        });
                    });
                });
                // whenAfterDeployed
    ...
    Actions.prototype.reconfig = function (deployment) {
        ...
        var _loop_1 = function(os_1) {
            var sessionsInfo = this_1.sessionsMap[os_1];
    ...
    Actions.prototype.logs = function (options) {
        ...
        var _loop_2 = function(os_2) {
            var sessionsInfo = this_2.sessionsMap[os_2];
            sessionsInfo.sessions.forEach(function (session) {
        ...
        var this_2 = this;
        for (var os_2 in this.sessionsMap) {
            _loop_2(os_2);
        }
    };
    /**
    ...
    */
     ...
     */
    Actions.prototype.whenAfterDeployed = function (deployment, error, summaryMaps) {
