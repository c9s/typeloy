...
var BaseAction = (function () {
    ...
    */
    ...
    BaseAction.prototype._executePararell = function (actionName, deployment, args) {
        var _this = this;
    ...
    BaseAction.prototype.reconfig = function (deployment) {
        var _this = this;
        var self = this;
        var sessionInfoList = [];
        var sessionsMap = this.createSiteSessionsMap(this.config, null);
    ...
    BaseAction.prototype.whenBeforeBuilding = function (deployment) {
