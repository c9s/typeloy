...
var BaseAction = (function () {
    ...
    */
    BaseAction.prototype.createSiteSessionsMap = function (siteName) {
        if (siteName === void 0) { siteName = "default"; }
        var site = this.getSiteConfig(siteName);
        if (!site) {
            throw new Error(siteName + " is not found in the sites.");
        }
    ...
    BaseAction.prototype.executePararell = function (actionName, deployment, site, args) {
        var _this = this;
        var sessionsMap = this.createSiteSessionsMap(site);
