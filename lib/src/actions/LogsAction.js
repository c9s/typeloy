...
var LogsAction = (function (_super) {
    ...
    function LogsAction(config, logConfig) {
        if (logConfig === void 0) { logConfig = {}; }
        _super.call(this, config);
        this.logConfig = _.extend({
            "onStdout": function (hostPrefix, data) {
                process.stdout.write(hostPrefix + data.toString());
            },
            "onStderr": function (hostPrefix, data) {
    ...
    LogsAction.prototype.run = function (deployment, sites, options) {
        ...
        var _loop_1 = function(i) {
            ...
            sitesPromise = sitesPromise.then(function () {
                ...
                var sessionGroupPromises = _.map(sessionsMap, function (sessionGroup, os) {
                        ...
                        return new Promise(function (resolve) {
                            session.execute(command, {
                                "onStdout": function (data) {
                                    _this.logConfig.onStdout(hostPrefix, data);
                                },
                                "onStderr": function (data) {
                                    _this.logConfig.onStderr(hostPrefix, data);
                                }
                            }, function () {
                                resolve();
                            });
