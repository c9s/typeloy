...
var LinuxTasks = (function () {
    function LinuxTasks() {
    }
    LinuxTasks.setup = function (config) {
    ...
    LinuxTasks.deploy = function (bundlePath, env, deployCheckWaitTime, appName, enableUploadProgressBar) {
    ...
    ;
    LinuxTasks.reconfig = function (env, appName) {
    ...
    LinuxTasks.restart = function (appName) {
    ...
    LinuxTasks.stop = function (appName) {
    ...
    LinuxTasks.start = function (appName) {
    ...
    LinuxTasks.installStud = function (taskList) {
        taskList.executeScript('Installing Stud', {
            script: path.resolve(SCRIPT_DIR, 'install-stud.sh')
        });
    };
    LinuxTasks.configureStud = function (taskList, pemFilePath, port) {
